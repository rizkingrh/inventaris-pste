...
<section class="bg-gray-50">
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <img class="flex items-center mb-6" src="img/logo.png" alt="logo" width="100">
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form action="/login" method="POST" class="space-y-4 md:space-y-6" >
                    ...
                    <div>
                        ...
                        <input type="text" name="username" id="username" placeholder="Username" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 @error('username') is-invalid @enderror" autofocus>
