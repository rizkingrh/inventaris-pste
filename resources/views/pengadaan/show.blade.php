    ...
    <div class="bg-white shadow rounded-md p-4 mt-4">
        ...
        <div class="relative overflow-x-auto sm:rounded-lg p-2">
            ...
            <div class="grid gap-4 mb-8 sm:grid-cols-2">
                <div>
                    <label for="nomer_pengadaan" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nomor
                        Pengadaan</label>
                    <input type="text" name="nomer_pengadaan" id="nomer_pengadaan"
                        ...
                        placeholder="PGN000" required="" value="{{ $data->nomer_pengadaan }}" disabled readonly>
                </div>
                <div>
                    <label for="kode_supplier" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kode
                        Supplier</label>
                    <input type="text" name="kode_supplier" id="kode_supplier"
                        class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        placeholder="PGN000" required="" value="{{ $data->supplier->kode_supplier }}" disabled
                        readonly>
                </div>
            </div>
            <div class="pb-4 bg-white flex justify-between items-center">
                <form action="{{ url('pengadaan-item') }}" id="searchForm" name="searchForm" method="get">
