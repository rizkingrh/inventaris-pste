        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Supplier</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="bg-white shadow rounded-md p-4 mt-4">
        ...
        <div class="relative overflow-x-auto sm:rounded-lg p-2">
            <div class="text-left mb-4">
                <p class="text-lg font-semibold">Supplier</p>
                <p class="text-sm ">Daftar supplier yang terdapat pada Laboratorium Program Studi Teknik Elektro
                </p>
            </div>
            <div class="pb-4 bg-white flex justify-between items-center">
                <form action="{{ url('supplier') }}" id="searchForm" name="searchForm" method="get">
