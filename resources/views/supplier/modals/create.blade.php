                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="text" name="kode_supplier" id="kode_supplier"
                            ...
                            placeholder="SPL000" required="" value="{{ old('kode_supplier') }}">
                    </div>
                    <div>
                        ...
                        <input type="text" name="no_telp" id="no_telp"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Masukan nomor telepon" required="" value="{{ old('no_telp') }}">
                    </div>
                    <div class="sm:col-span-2">
                        <label for="alamat_supplier"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Alamat Supplier</label>
