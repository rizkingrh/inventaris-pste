...
@section('content')
    ...
    <div class="bg-white shadow rounded-md p-4 mt-4">
        ...
        <div class="relative overflow-x-auto sm:rounded-lg p-2">
            <div class="text-left mb-4">
                ...
                <p class="text-sm ">Daftar kategori barang yang terdapat pada Laboratorium Program Studi Teknik Elektro
                </p>
            </div>
    ...
    @include('kategoribarang.modals.delete')
    @include('kategoribarang.modals.edit')
    @include('kategoribarang.modals.create')
@endsection
