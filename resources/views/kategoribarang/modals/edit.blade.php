    ...
    <div id="edit-modal-{{ $item->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <form action="{{ url('kategori-barang/' . $item->id) }}" method="POST" class="p-4 md:p-5">
                    @csrf
                    @method('PUT')
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2">
                            ...
                            <input type="text" name="kode_kategori" id="kode_kategori"
                                ...
                                placeholder="KTG000" required="" value="{{ $item->kode_kategori }}" disabled
                                readonly>
                        </div>
                        <div class="col-span-2">
                            ...
                            <input type="text" name="nama_kategori" id="nama_kategori"
                                ...
                                placeholder="Masukan nama kategori" required="" value="{{ $item->nama_kategori }}">
                        </div>
                    </div>
                    <button type="submit"
