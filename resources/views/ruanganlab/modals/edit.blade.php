    ...
    <div id="edit-modal-{{ $item->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <form action="{{ url('ruangan-lab/' . $item->id) }}" method="POST" class="p-4 md:p-5">
                    @csrf
                    @method('PUT')
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        <div>
                            ...
                            <input type="text" name="kode_ruangan" id="kode_ruangan"
                                ...
                                placeholder="RLB000" required="" value="{{ $item->kode_ruangan }}" disabled readonly>
                        </div>
                        <div>
                            ...
                            <input type="text" name="nama_ruangan" id="nama_ruangan"
                                ...
                                placeholder="Masukan nama ruangan" required="" value="{{ $item->nama_ruangan }}">
                        </div>
