...
@section('content')
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Ruangan Lab</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="bg-white shadow rounded-md p-4 mt-4">
        ...
        <div class="relative overflow-x-auto sm:rounded-lg p-2">
            <div class="text-left mb-4">
                <p class="text-lg font-semibold">Ruangan Lab</p>
                <p class="text-sm ">Daftar ruangan yang terdapat pada Laboratorium Program Studi Teknik Elektro
                </p>
            </div>
    ...
    @include('ruanganlab.modals.delete')
    @include('ruanganlab.modals.edit')
    @include('ruanganlab.modals.create')
@endsection
