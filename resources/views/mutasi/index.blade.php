...
@section('content')
    ...
    <div class="bg-white shadow rounded-md p-4 mt-4">
        ...
        <div class="relative overflow-x-auto sm:rounded-lg p-2">
            <div class="text-left mb-4">
                <p class="text-lg font-semibold">Mutasi</p>
                <p class="text-sm ">Daftar pemindahan barang pada Laboratorium Program Studi Teknik Elektro
                </p>
            </div>
            <div class="pb-4 bg-white flex justify-between items-center">
                <form action="{{ url('mutasi') }}" id="searchForm" name="searchForm" method="get">
    ...
    @include('mutasi.modals.delete')
    @include('mutasi.modals.edit')
    @include('mutasi.modals.create')
@endsection
