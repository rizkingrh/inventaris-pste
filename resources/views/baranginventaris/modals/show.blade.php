                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea id="keterangan" name="keterangan" rows="2"
                            ...
                            placeholder="Masukan keterangan" disabled readonly>{{ $item->barang->keterangan }}</textarea>
                    </div>
                </div>
            </div>
        </div>
