    ...
    <div id="edit-modal-{{ $item->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <form action="{{ url('barang-inventaris/' . $item->id) }}" method="POST" class="p-4 md:p-5">
                    @csrf
                    @method('PUT')
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        <div>
                            <label for="kode_inventaris"
                            ...
                            <input type="text" name="kode_inventaris" id="kode_inventaris"
                                ...
                                placeholder="INV000" required="" value="{{ $item->kode_inventaris }}" readonly
                                disabled>
                        </div>
                        <div>
                            ...
                            <div class="relative max-w-sm">
                                ...
                                <input datepicker datepicker-buttons datepicker-autoselect-today type="text"
                                    ...
                                    placeholder="Pilih tanggal" value="{{ $item->tanggal_masuk }}">
                            </div>
                        </div>
                        <div class="sm:col-span-2">
                            ...
                            <select id="status_barang" name="status_barang"
                                ...
                                <option selected disabled hidden value="{{ $item->status_barang }}">
                                    {{ $item->status_barang }}</option>
