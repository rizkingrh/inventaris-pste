...
@section('content')
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="/peminjaman"
                        class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Peminjaman</a>
                </div>
            </li>
    ...
    <div class="bg-white shadow rounded-md p-4 mt-4">
        ...
        <div class="relative overflow-x-auto sm:rounded-lg p-2">
            <div class="text-left mb-4">
                <p class="text-lg font-semibold">Detail Barang Dipinjam</p>
                <p class="text-sm ">Daftar barang dipinjam pada Laboratorium Program Studi Teknik Elektro
                </p>
            </div>
            <div class="grid gap-4 mb-8 sm:grid-cols-2">
                <div>
                    <label for="nomor_peminjaman" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nomor
                        Peminjaman</label>
                    <input type="text" name="nomor_peminjaman" id="nomor_peminjaman"
                        ...
                        value="{{ $data->nomor_peminjaman }}" disabled readonly>
                </div>
                <div>
                    ...
                    <input type="text" name="name" id="name"
                        class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        value="{{ $data->user->name }}" disabled readonly>
                </div>
            </div>
    ...
    @include('peminjaman.barangDipinjam.create')
    @include('peminjaman.barangDipinjam.delete')
    @include('peminjaman.barangDipinjam.show')
@endsection
