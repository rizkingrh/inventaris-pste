    ...
    <div id="edit-modal-{{ $item->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <form action="{{ url('peminjaman/' . $item->id) }}" method="POST" class="p-4 md:p-5">
                    @csrf
                    @method('PUT')
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        <div>
                            ...
                            <input type="text" name="nomor_peminjaman" id="nomor_peminjaman"
                                ...
                                value="{{ $item->nomor_peminjaman }}" disabled readonly>
                        </div>
                        <div>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea id="keterangan" name="keterangan" rows="2"
                                ...
                                placeholder="Masukan keterangan" required>{{ $item->keterangan }}</textarea>
                        </div>
                    </div>
                    <button type="submit"
